...
export class SettingsComponent implements OnInit {
  ...
  plzSelectGroup="Please Select Group.";
  ...
  console.log(this.userDetailsForm.value.groups);
    for(let cat of this.selectedItems){
        ...
        this.userDetailsForm.value.categories=categeries;
                ...
                if(this.userDetailsForm.valid && this.userDetailsForm.value.password != '' && this.userDetailsForm.value.reTypePassword != '' && this.userDetailsForm.value.groups !='')
                  {
                    this.isGroupsRequied=false;
                    this.pwdIsRequired="";
